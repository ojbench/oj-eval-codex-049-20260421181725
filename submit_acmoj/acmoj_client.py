...
def main():
    ...
    # Submit raw code sub-command
    submit_code_parser = subparsers.add_parser("submit-file", help="Submit code from a file")
    submit_code_parser.add_argument("--problem-id", type=int, required=True, help="Problem ID")
    submit_code_parser.add_argument("--language", type=str, default="cpp", help="Language (e.g., cpp)")
    submit_code_parser.add_argument("--file", type=str, required=True, help="Path to code file")
